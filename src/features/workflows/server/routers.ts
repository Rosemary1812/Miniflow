...
export const workflowRouter = createTRPCRouter({
  ...
  getOne: protectedProcedure.input(z.object({ id: z.string() })).query(async ({ ctx, input }) => {
    ...
    const edges: Edge[] = workflow.connections.map(connecction => ({
      id: connecction.id,
      source: connecction.fromNodeId,
      target: connecction.toNodeId,
      sourceHandle: connecction.fromOutput,
      targetHandle: connecction.toInput,
    }));
