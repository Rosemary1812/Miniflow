      ...
      <CardContent className="space-y-4">
        <div>
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <p className="text-sm">{formaStatus(execution.status)}</p>
            </div>
            <div>
          ...
          {execution.error && (
            <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
              <div>
                <p className="tetx-sm font-medium text-red-900 mb-2">{execution.error}</p>
              </div>
            </div>
          )}
            ...
            <Collapsible open={showStackTrace} onOpenChange={setShowStackTrace}>
              <CollapsibleTrigger asChild>
                <Button variant="ghost" size="sm" className="text-red-900 hover:bg-red-100">
                  {showStackTrace ? 'Hidden stack trace' : 'show stack trace'}
                </Button>
              </CollapsibleTrigger>
              <CollapsibleContent>
        ...
        {execution.output && (
          <div className="mt-6 p-4 bg-muted rounded-md">
            ...
            <pre className="text-xs font-mono ovweflow-auto">
